...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'twig.extension.kint' => 'getTwig_Extension_KintService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\WebSiteBundle\\Entity'))), 'WebSiteBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9e94bc329a6278c7538f496b394c02c42a7ec163846919354e57cc025a184c94');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('twig.extension.kint'));
    ...
    /**
     * Gets the 'twig.extension.kint' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Cg\KintBundle\Twig\Extension\KintExtension A Cg\KintBundle\Twig\Extension\KintExtension instance.
     */
    protected function getTwig_Extension_KintService()
    {
        return $this->services['twig.extension.kint'] = new \Cg\KintBundle\Twig\Extension\KintExtension(true, '5', '60', $this->get('kernel'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f6e5fec2c64fea92306ee0c926b09fbe594e13c2');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('570ce864efd347.55611615')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CgKintBundle' => 'Cg\\KintBundle\\CgKintBundle',
            ...
            'secret' => 'f6e5fec2c64fea92306ee0c926b09fbe594e13c2',
            'locale' => 'en',
            'app' => 'Karaté Club Ennour',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f6e5fec2c64fea92306ee0c926b09fbe594e13c2',
            ...
            'cg_kint.enabled' => true,
            'cg_kint.nesting_depth' => '5',
            'cg_kint.string_length' => '60',
            'twig.extension.kint.class' => 'Cg\\KintBundle\\Twig\\Extension\\KintExtension',
