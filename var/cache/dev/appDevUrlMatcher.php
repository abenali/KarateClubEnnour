...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'WebSiteBundle\\Controller\\MainController::indexAction',  '_route' => 'homepage',);
        }

        // contact
        if ($pathinfo === '/contact_us') {
            return array (  '_controller' => 'WebSiteBundle\\Controller\\ContactController::loadContactFormAction',  '_route' => 'contact',);
        }
